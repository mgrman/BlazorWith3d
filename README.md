...
- 4 Source Generators:
  ...
  - BlazorWith3d.CodeGenerator.MemoryPack: 
    - to generate implementation of marked interfaces that implement methods via messages over a two-way binary API in TypeScript (for now tighly bound to using MemoryPack as serializer for binary messages)
...
- Unity packages
  - BlazorWith3d.Unity.UnityPackage
    - Unity specific implementaiton of Binary API over JS interop
    ...
    - Contains binaries of the BlazorWith3d.CodeGenerator.DotnetBinaryApiBinding generator annotated in a way to be usable in Unity
      - Include Marker.BlazorWith3d.CodeGenerator.DotnetBinaryApiBinding.additionalfile file in a asmdef you want the generator to be used in Unity
