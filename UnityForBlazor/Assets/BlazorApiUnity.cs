...
internal static class BlazorApi
{
    ...
    private static IDictionary<int, AwaitableCompletionSource<string>> _responseAwaitables = new Dictionary<int, AwaitableCompletionSource<string>>();
    ...
    private static extern void SendMessageFromUnity(int msgId,string message,Action<int,string> onResponseReceived);
