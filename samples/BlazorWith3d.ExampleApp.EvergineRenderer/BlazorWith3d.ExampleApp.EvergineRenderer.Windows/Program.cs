...
namespace BlazorWith3d.ExampleApp.EvergineRenderer.Windows
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var window = windowsSystem.CreateWindow("BlazorWith3d.ExampleApp.EvergineRenderer - DX11", width, height);
